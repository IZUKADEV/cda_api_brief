...
exports.Create = async (req, res) => {
  // on va créer une fonction asynchrone pour créer du délai et pour que toutes les étapes soient compléter au fur à mesure
  const { content } = req.body

  if (!content) {
    // Si content n'existe pas ou est vide
